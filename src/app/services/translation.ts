...
const de = {
  ...
  legalImprintText:
    '[Jonas Hildebrand]\n[Straße und Hausnummer]\n[PLZ und Ort]\n\nE-Mail: [jhildebrand94@googlemail.com]',
...
legalScopeText: 'Portfolio wurde im Rahmen eines studentischen Gruppenprojekts in einem Webentwicklungs-Bootcamp der Developer Akademie GmbH entwickelt. Es dient Bildungszwecken und ist nicht für die umfangreiche private oder geschäftliche Nutzung bestimmt. Daher können wir keine durchgängige Verfügbarkeit, Zuverlässigkeit, Richtigkeit oder sonstige Qualität dieses Produkts garantieren. Das Design von Portfolio ist Eigentum der Developer Akademie GmbH. Die unbefugte Nutzung, Vervielfältigung, Änderung, Verbreitung oder Reproduktion des Designs ist strengstens untersagt.',
legalProprietaryTitle: 'Schutzrechte',
legalProprietaryText: 'Abgesehen von dem Design, das der Developer Akademie GmbH gehört, behalten wir, die genannten Studierenden, alle Eigentumsrechte an Portfolio, einschließlich aller damit verbundenen urheberrechtlich geschützten Materialien, Marken und sonstigen geschützten Informationen.',
legalUseTitle: 'Nutzung des Produkts',
legalUseText: 'Portfolio ist ausschließlich für rechtmäßige Zwecke und in Übereinstimmung mit allen geltenden Gesetzen und Vorschriften zu verwenden. Jede Nutzung von Portfolio für illegale Aktivitäten oder um eine andere Person zu belästigen, zu schädigen, zu bedrohen oder einzuschüchtern, ist strengstens untersagt. Du bist allein für deine Interaktionen mit anderen Nutzern von Portfolio verantwortlich.',
...
legalProprietaryText: 'Aside from the design owned by Developer Akademie GmbH, we, the listed students, retain all proprietary rights in Portfolio, including any associated copyrighted material, trademarks, and other proprietary information.',
